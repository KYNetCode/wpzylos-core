...
class Application implements ApplicationInterface
{
     ...
     * @param ContainerInterface|null $container DI container (auto-creates default if null)
     */
    ...
    /**
     * Create the default container instance.
     *
     * @return ContainerInterface
     */
    private function createDefaultContainer(): ContainerInterface
    {
        // Use WPZylos Container if available, otherwise fail gracefully
        if (class_exists(\WPZylos\Framework\Container\Container::class)) {
            return new \WPZylos\Framework\Container\Container();
        }

        throw new \RuntimeException(
            'No container provided and wpzylos-container package not found. '
            . 'Install wpzylos-container or pass a PSR-11 container to Application.'
        );
    }
